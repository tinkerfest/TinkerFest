...
<head>
    ...
    <script>
        ...
        function updateRandom( percentComplete ){
            if( percentComplete == 100 && !_G.video_success ){
                 $('.my_video_progress').text("Resizing Video, Please Wait..");
            }else{
                var randomTime = rand(400,1500);
                setTimeout(function(){
